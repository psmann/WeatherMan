...
internal class WeatherResult(private val sharedPreferenceStorage: SharedPreferenceStorage) : TimeZoneResult.TimeZoneListener {
    ...
    private fun forecastCall(geoCoordinates: Array<Double>, cityPref: String) {
        ...
        forecastCall.enqueue(object : Callback<DailyForecastDto> {
            override fun onResponse(call: Call<DailyForecastDto>, response: Response<DailyForecastDto>) {
            ...
            override fun onFailure(call: Call<DailyForecastDto>, t: Throwable) {}
        })
    }
