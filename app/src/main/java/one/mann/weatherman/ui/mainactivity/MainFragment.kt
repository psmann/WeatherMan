...
import one.mann.weatherman.ui.mainactivity.adapter.CityRecyclerAdapter
...
internal class MainFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        mainViewModel.weatherLiveData.observe(this,
                Observer { sharedPrefStorage ->
                    cityRecyclerAdapter.bindData(sharedPrefStorage!!, position)
                })
