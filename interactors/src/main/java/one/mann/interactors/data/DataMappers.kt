...
internal fun mapToWeather(currentWeather: CurrentWeather, dailyForecast: List<DailyForecast>,
    ...
    return Weather(
            ...
            hourlyForecast[0].temp.setUnitsType(units).roundOff(),
            ...
            hourlyForecast[1].temp.setUnitsType(units).roundOff(),
            ...
            hourlyForecast[2].temp.setUnitsType(units).roundOff(),
            ...
            hourlyForecast[3].temp.setUnitsType(units).roundOff(),
            ...
            hourlyForecast[4].temp.setUnitsType(units).roundOff(),
            ...
            hourlyForecast[5].temp.setUnitsType(units).roundOff(),
            ...
            hourlyForecast[6].temp.setUnitsType(units).roundOff(),
