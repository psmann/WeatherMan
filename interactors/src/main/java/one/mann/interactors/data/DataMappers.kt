...
internal fun mapToWeather(currentWeather: CurrentWeather, dailyForecast: List<DailyForecast>,
    ...
    return Weather(
            ...
            currentWeather.currentTemperature.setTempUnits(units).addSuffix(DEGREES),
            feelsLike(currentWeather.currentTemperature, currentWeather.humidity, currentWeather.windSpeed).setTempUnits(units)
                    .addSuffix(DEGREES),
            ...
            currentWeather.windSpeed.setWindUnits(units).addSuffix(if (units == IMPERIAL) MILES_PER_HOUR else KM_PER_HOUR),
            currentWeather.windDirection.addSuffix(DEGREES),
            epochToDate(currentWeather.lastUpdated, timezone),
            currentWeather.visibility.setVisibilityUnits(units).addSuffix(if (units == IMPERIAL) MILES else KILO_METERS),
            ...
            dailyForecast[0].minTemp.setTempUnits(units).roundOff().addSuffix(DEGREES),
            dailyForecast[0].maxTemp.setTempUnits(units).roundOff().addSuffix(DEGREES),
            dailyForecast[0].forecastIconId,
            epochToDay(dailyForecast[1].forecastDate, timezone),
            dailyForecast[1].minTemp.setTempUnits(units).roundOff().addSuffix(DEGREES),
            dailyForecast[1].maxTemp.setTempUnits(units).roundOff().addSuffix(DEGREES),
            dailyForecast[1].forecastIconId,
            epochToDay(dailyForecast[2].forecastDate, timezone),
            dailyForecast[2].minTemp.setTempUnits(units).roundOff().addSuffix(DEGREES),
            dailyForecast[2].maxTemp.setTempUnits(units).roundOff().addSuffix(DEGREES),
            dailyForecast[2].forecastIconId,
            epochToDay(dailyForecast[3].forecastDate, timezone),
            dailyForecast[3].minTemp.setTempUnits(units).roundOff().addSuffix(DEGREES),
            dailyForecast[3].maxTemp.setTempUnits(units).roundOff().addSuffix(DEGREES),
            dailyForecast[3].forecastIconId,
            epochToDay(dailyForecast[4].forecastDate, timezone),
            dailyForecast[4].minTemp.setTempUnits(units).roundOff().addSuffix(DEGREES),
            dailyForecast[4].maxTemp.setTempUnits(units).roundOff().addSuffix(DEGREES),
            dailyForecast[4].forecastIconId,
            epochToDay(dailyForecast[5].forecastDate, timezone),
            dailyForecast[5].minTemp.setTempUnits(units).roundOff().addSuffix(DEGREES),
            dailyForecast[5].maxTemp.setTempUnits(units).roundOff().addSuffix(DEGREES),
            dailyForecast[5].forecastIconId,
            epochToDay(dailyForecast[6].forecastDate, timezone),
            dailyForecast[6].minTemp.setTempUnits(units).roundOff().addSuffix(DEGREES),
            dailyForecast[6].maxTemp.setTempUnits(units).roundOff().addSuffix(DEGREES),
            dailyForecast[6].forecastIconId,
            epochToHour(hourlyForecast[0].forecastTime, timezone),
            hourlyForecast[0].temp.setTempUnits(units).roundOff().addSuffix(DEGREES),
            ...
            hourlyForecast[1].temp.setTempUnits(units).roundOff().addSuffix(DEGREES),
            ...
            hourlyForecast[2].temp.setTempUnits(units).roundOff().addSuffix(DEGREES),
            ...
            hourlyForecast[3].temp.setTempUnits(units).roundOff().addSuffix(DEGREES),
            ...
            hourlyForecast[4].temp.setTempUnits(units).roundOff().addSuffix(DEGREES),
            ...
            hourlyForecast[5].temp.setTempUnits(units).roundOff().addSuffix(DEGREES),
            ...
            hourlyForecast[6].temp.setTempUnits(units).roundOff().addSuffix(DEGREES),
